...
class ArticleDao extends ModelDao {
    ...
    public function groupeByCategory() {
        $req = $this->db->prepare("SELECT * FROM Article GROUP BY categorie");
        $req->execute();
    ...
    public function where($column, $operator, $value) {
        $req = $this->db->prepare("SELECT * FROM Article WHERE $column $operator :value");
