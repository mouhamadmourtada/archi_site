    ...
    <div class="my-5 p-10">
        <div class="flex justify-between items-center mx-auto">
            <div class="flex justify-between w-full">
                ...
                <button>
                    <a href="/archi/user/<?= $user->getId() ?>/show" class="btn btn-primary bg-slate-200 hover:slate-300 text-primary py-1 px-3 rounded my-3 hover:shadow">Retour</a>
                    <!-- <a href="/archi/user"></a> -->
                </button>
            </div>
        </div>
        <div class="border border-gray-200 shadow-xl mt-2">
            <form action="/archi/user/<?= $user->getId() ?>/update" method="POST" class="max-w-4xl mx-auto">
