        ...
        <div class="flex justify-between items-center mx-auto">
            <div class="flex justify-between w-full">
                ...
                <div>
                    ...
                    <button>
                        <a href="/archi/user" class="btn btn-primary bg-slate-200 hover:slate-300 text-primary py-1 px-3 rounded my-3 hover:shadow">Retour</a>
                        <!-- <a href="/archi/user"></a> -->
                    </button>
                    <button>
                        <a href="/archi/user/<?= $user->getId() ?>/edit" class="btn btn-primary bg-slate-200 hover:slate-300 text-primary py-1 px-3 rounded my-3 hover:shadow">Modifier</a>
                        <!-- <a href="/archi/user"></a> -->
                    </button>
    ...
    <div class="border shadow p-5 mt-10 rounded">
        <div class="flex justify-between items-center">
            ...
            <button class="btn btn-primary bg-slate-200 hover:slate-300 text-primary py-1 px-3 rounded my-3 hover:shadow">
                <a href="/archi/user/<?= $user->getId() ?>/generateToken" class="btn btn-primary bg-slate-200 hover:slate-300 text-primary py-1 px-3 rounded my-3 hover:shadow">
                    Générer un token
                </a>
