...
<div>
    <div class="my-5 p-5">
        ...
        <div class="border border-gray-200 shadow-xl p-5 mt-2 min-h-96">
            ...
            <form action="/archi/article/update" method="POST" class="flex flex-col">
                ...
                <div class="flex justify-end gap-2 mt-5">
                    <!-- bouton pour annuler -->
                    <a href="/archi/article/<?= $article->getId() ?>/show" class="btn btn-red-500 bg-slate-200 hover:red-700 text-primary py-1 px-5 rounded my-3 hover:shadow-xl">Annuler</a>
